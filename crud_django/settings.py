...
SECRET_KEY = 'django-insecure-%xa$ys5zbg_)#+8y-h%4)dv_%exhb-v!z(3c0ljjl_b+_k1$h3'
...
LOCAL_APP = ["productos","crud_django"]


INSTALLED_APPS = DEFAUL_APPS + LOCAL_APP + TERCEROS_APP 
